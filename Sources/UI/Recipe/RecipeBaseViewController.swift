...
public class RecipeBaseViewController: UIViewController {
    // MARK: - Properties
...
extension RecipeBaseViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        RecipeBaseViewController.tableCellHeight
    }
